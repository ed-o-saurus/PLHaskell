...
$$
    import PGutils (unPGm, PGm, query, QueryResults (InsertReturningResults), QueryResultValue (QueryResultValueInt4, QueryResultValueText), raiseError)
    import Data.Text (Text)
...
$$
    import PGutils (unPGm, PGm, query, QueryResults (SelectResults), QueryResultValue (QueryResultValueInt4, QueryResultValueText), raiseError)
    import Data.Text (Text)
...
$$
    import PGutils (unPGm, PGm, query, QueryResults (DeleteResults), raiseError)
    import Data.Text (Text)
...
$$
    import PGutils (unPGm, PGm, query, QueryResults (SelectResults), QueryResultValue (QueryResultValueComposite, QueryResultValueInt4, QueryResultValueText, QueryResultValueFloat8), raiseError)
    import Data.Text (Text)
    ...
    query_composite = unPGm $ do
        ...
        assert (delta_schema0 == "plhaskellu_test") "Bad delta_schema0"
        assert (delta_type0 == "delta") "Bad delta_type0"
        assert (bravo_schema0 == "plhaskellu_test") "Bad bravo_schema0"
        assert (bravo_type0 == "bravo") "Bad bravo_type0"
        assert (alpha_schema0 == "plhaskellu_test") "Bad alpha_schema0"
        assert (alpha_type0 == "alpha") "Bad alpha_type0"
        assert (charlie_schema0 == "plhaskellu_test") "Bad charlie_schema0"
        ...
        assert (delta_schema1 == "plhaskellu_test") "Bad delta_schema1"
        assert (delta_type1 == "delta") "Bad delta_type1"
        assert (bravo_schema1 == "plhaskellu_test") "Bad bravo_schema1"
        assert (bravo_type1 == "bravo") "Bad bravo_type1"
        assert (alpha_schema1 == "plhaskellu_test") "Bad alpha_schema1"
        assert (alpha_type1 == "alpha") "Bad alpha_type1"
        assert (charlie_schema1 == "plhaskellu_test") "Bad charlie_schema1"
        ...
        assert (delta_schema2 == "plhaskellu_test") "Bad delta_schema2"
        assert (delta_type2 == "delta") "Bad delta_type2"
        assert (bravo_schema2 == "plhaskellu_test") "Bad bravo_schema2"
        assert (bravo_type2 == "bravo") "Bad bravo_type2"
        assert (charlie_schema2 == "plhaskellu_test") "Bad charlie_schema2"
        assert (charlie_type2 == "charlie") "Bad charlie_type2"

        let [QueryResultValueComposite (delta_schema3, delta_type3) Nothing] = row3

        assert (delta_schema3 == "plhaskellu_test") "Bad delta_schema3"
...
$$
    import PGutils (unPGm, PGm, raiseError, query, QueryResults (SelectResults), QueryParam (QueryParamComposite, QueryParamText, QueryParamInt4, QueryParamFloat8), QueryResultValue (QueryResultValueComposite, QueryResultValueText, QueryResultValueInt4, QueryResultValueFloat8))
...
$$
    import PGutils (unPGm, PGm, raiseError, query, arrayMap, Array(Array6D), QueryResults(SelectResults), QueryResultValue(QueryResultValueArray, QueryResultValueInt4))
    import Data.Int (Int32)
    import Data.Text (Text)
